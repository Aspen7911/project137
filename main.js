...
function draw() {
    ...
    if (status != "") {
        ...
        for (i = 0; i < objects.length; i++) {
            document.getElementById("status").innerHTML = "status:objectdectected";
            document.getElementById("number_of_objects").innerHTML = "number_of_objectsdectected" + objects.length;
            fill("#98FF98");
